...
import Whatsapp from "./src/Toptab/Whatsapp";

import House from "./Drawer/House";
import Veed from "./Drawer/Veed";
import Hut from "./Drawer/Hut";

import Drawercont from "./Drawer/Drawercont";
...
return(
    ...
    <View style={{height:'100%',width:'100%'}}>
      <View style={{height:'35%',width:'100%',backgroundColor:'black'}}>
        ...
        <View style={{marginLeft:20,flexDirection:'row',marginTop:10,marginBottom:20}}>
